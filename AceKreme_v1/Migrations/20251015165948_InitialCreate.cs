    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "Description", "Name", "Price", "ProductImagePath", "Stock" },
                values: new object[,]
                {
                    { 1, "Queen size mattress", "Classic Mattress", 499.99m, null, 12 },
                    { 2, "Comfort pillow", "Memory Foam Pillow", 59.99m, null, 50 }
                });
